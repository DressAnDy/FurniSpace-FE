...
const statusClasses: Record<string, string> = {
  ...
  PROPOSAL_DRAFTING: 'bg-orange-50 text-orange-700 ring-orange-100',
  WAITING_FOR_CUSTOMER_REVIEW: 'bg-indigo-50 text-indigo-700 ring-indigo-100',
  REVISION_REQUESTED: 'bg-red-50 text-red-700 ring-red-100',
  ...
  'Proposal Drafting': 'bg-orange-50 text-orange-700 ring-orange-100',
  'Customer Review': 'bg-indigo-50 text-indigo-700 ring-indigo-100',
