...
export const financialCopy = {
  vi: {
    ...
    receivablesSubtitle: 'Các khoản đang mở và số còn lại trên đơn hàng.',
    ...
    projectsTitle: 'Sổ thu theo dự án',
    projectsSubtitle:
      'Chọn dự án để xem sao kê tiền thật. So sánh thu theo kỳ → KPI Đã thu. Đòi nợ theo đơn → Công nợ.',
    ...
    listBtnDiscounts: 'Giảm giá',
    customerSales: 'Khách / Sales',
    collectedInPeriod: 'Thu (kỳ)',
    hasReceivable: 'Công nợ?',
    lastPaidInPeriod: 'Thu cuối',
    filterAll: 'Tất cả',
    filterHasOrder: 'Có đơn hàng',
    filterNoOrder: 'Chưa có đơn',
    filterHasDebt: 'Còn công nợ',
    filterNoDebt: 'Không còn nợ',
    projectStatusFilter: 'Trạng thái dự án',
    commercialContext: 'Bối cảnh commercial',
    startFeeLine: 'Phí khởi tạo',
    startFeeNotCreated: 'Chưa tạo phí khởi tạo',
    orderPriceChain: 'Chuỗi giá đơn',
    salesLabel: (name: string) => `Sales: ${name}`,
    salesResponsible: 'Sales phụ trách',
    statementPeriodNote: (from: string, to: string) => `Sao kê trong khoảng ${from} → ${to}`,
    bridgeKpiBreakdown: 'Xem breakdown thu theo kỳ (KPI)',
    bridgeOpenReceivables: (orderCode: string) => `Mở công nợ đơn ${orderCode}`,
    openProjectLedger: 'Xem sổ thu dự án',
    openDiscountDetail: 'Xem chi tiết giảm giá',
    openLedgerFromDrilldown: 'Mở sở thu dự án',
    discountEyebrow: 'Commercial discount',
    discountTitle: 'Báo cáo giảm giá',
    discountSubtitle: 'Phân tích giảm giá theo đơn đã xác nhận — không phải tiền thu hay công nợ.',
    discountDisclaimer:
      'Giảm giá commercial là khoản trừ vào giá trị đơn trước khi chốt giá cuối. Không tính là doanh thu, công nợ hay hoàn tiền.',
    loadingDiscountSummary: 'Đang tải tổng hợp giảm giá...',
    loadingDiscountList: 'Đang tải danh sách giảm giá...',
    loadingDiscountDetail: 'Đang tải chi tiết giảm giá...',
    closeDiscountDetail: 'Đóng chi tiết giảm giá',
    discountTotalAmount: 'Tổng giảm giá',
    discountAverageRate: 'Tỷ lệ TB',
    discountOrderCount: 'Đơn có giảm giá',
    discountGrossValue: 'Giá trị gốc',
    discountFinalValue: 'Giá cuối',
    discountTrendTitle: 'Xu hướng giảm giá theo tháng',
    discountHasFilter: 'Có giảm giá',
    searchDiscounts: 'Tìm giảm giá',
    emptyDiscounts: 'Không có đơn trong khoảng này.',
    discountExceptionsTitle: 'Giảm giá bất thường',
    discountDetailTitle: 'Chi tiết giảm giá đơn',
    discountPriceChain: 'Chuỗi giá',
    discountItemAmount: 'Giảm theo dòng',
    discountOrderAmount: 'Giảm thêm đơn',
    discountNetBeforeVat: 'Trước VAT',
    discountVat: 'VAT',
    discountItemName: 'Sản phẩm',
    quantity: 'SL',
    unitPrice: 'Đơn giá',
  ...
  en: {
    ...
    receivablesSubtitle: 'Open items and remaining amounts on orders.',
    ...
    projectsTitle: 'Project cash ledger',
    projectsSubtitle:
      'Pick a project for its cash ledger. Period totals → Collected KPI. Order collection → Receivables.',
    ...
    listBtnDiscounts: 'Discounts',
    customerSales: 'Customer / Sales',
    collectedInPeriod: 'Collected (period)',
    hasReceivable: 'Receivable?',
    lastPaidInPeriod: 'Last paid',
    filterAll: 'All',
    filterHasOrder: 'Has order',
    filterNoOrder: 'No order',
    filterHasDebt: 'Has receivable',
    filterNoDebt: 'No receivable',
    projectStatusFilter: 'Project status',
    commercialContext: 'Commercial context',
    startFeeLine: 'Start fee',
    startFeeNotCreated: 'Start fee not created',
    orderPriceChain: 'Order price chain',
    salesLabel: (name: string) => `Sales: ${name}`,
    salesResponsible: 'Assigned sales',
    statementPeriodNote: (from: string, to: string) => `Statement for ${from} → ${to}`,
    bridgeKpiBreakdown: 'View period collection (KPI)',
    bridgeOpenReceivables: (orderCode: string) => `Open receivables for ${orderCode}`,
    openProjectLedger: 'Open project ledger',
    openDiscountDetail: 'View discount detail',
    openLedgerFromDrilldown: 'Open project ledger',
    discountEyebrow: 'Commercial discount',
    discountTitle: 'Discount report',
    discountSubtitle: 'Discount analysis on confirmed orders — not cash or receivables.',
    discountDisclaimer:
      'Commercial discount reduces gross order value before the final price. It is not revenue, receivable, or refund.',
    loadingDiscountSummary: 'Loading discount summary...',
    loadingDiscountList: 'Loading discount list...',
    loadingDiscountDetail: 'Loading discount detail...',
    closeDiscountDetail: 'Close discount detail',
    discountTotalAmount: 'Total discount',
    discountAverageRate: 'Avg. rate',
    discountOrderCount: 'Discounted orders',
    discountGrossValue: 'Gross value',
    discountFinalValue: 'Final value',
    discountTrendTitle: 'Monthly discount trend',
    discountHasFilter: 'Has discount',
    searchDiscounts: 'Search discounts',
    emptyDiscounts: 'No orders in this range.',
    discountExceptionsTitle: 'Unusual discounts',
    discountDetailTitle: 'Order discount detail',
    discountPriceChain: 'Price chain',
    discountItemAmount: 'Line discounts',
    discountOrderAmount: 'Order discount',
    discountNetBeforeVat: 'Before VAT',
    discountVat: 'VAT',
    discountItemName: 'Product',
    quantity: 'Qty',
